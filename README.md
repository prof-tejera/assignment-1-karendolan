...
5. Deploy your application using any method you like (we will provide instructions for GH actions), Deployed to: [https://prof-tejera.github.io/assignment-1-karendolan/](https://prof-tejera.github.io/assignment-1-karendolan/)
